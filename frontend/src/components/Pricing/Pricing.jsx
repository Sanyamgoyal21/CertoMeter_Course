            ...
            <div className="p-8">
              <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div className="space-y-6">
                  ...
                  <a
                    href={`https://wa.me/918360341355?text=${encodeURIComponent("Hi! 👋 I'm interested in the AI Career Accelerator course. I have a few questions before enrolling. Could you help me?")}`}
                    target="_blank"
                  ...
                  >
                    ...
                    <span className="ml-2">Have Questions? Chat Now</span>
                  </a>
